...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[draw, circle, fill=red!50] (node2) at (2,2) {2};
        \node[draw, circle, fill=red!50] (node3) at (4,2) {3};
        \node[draw, circle, fill=gray!50] (A) at (0,0) {A};
        \node[draw, circle, fill=gray!50] (B) at (2,0) {B};
        \node[draw, circle, fill=gray!50] (C) at (4,0) {C};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[draw, circle, fill=red!50] (node2) at (2,2) {2};
        \node[draw, circle, fill=red!50] (node3) at (4,2) {3};
        \node[draw, circle, fill=red!50] (node4) at (6,2) {4};
        \node[draw, circle, fill=gray!50] (A) at (0,0) {A};
        \node[draw, circle, fill=gray!50] (B) at (2,0) {B};
        \node[draw, circle, fill=gray!50] (C) at (4,0) {C};
        \node[draw, circle, fill=gray!50] (D) at (6,0) {D};
    ...
    \end{tikzpicture}
\end{center}
\hspace{1cm}\textit{This graph does not have a matching, as $2$ and $4$ are both only connected to $B$.}
\subsection{Graph $C$:}
\begin{center}
    \begin{tikzpicture}
        \node[draw, circle, fill=red!50] (node1) at (0,2) {1};
        ...
        \node[draw, circle, fill=red!50] (node3) at (4,2) {3};
        \node[draw, circle, fill=red!50] (node4) at (6,2) {4};
        \node[draw, circle, fill=red!50] (node5) at (8,2) {5};
        \node[draw, circle, fill=gray!50] (A) at (0,0) {A};
        \node[draw, circle, fill=gray!50] (B) at (2,0) {B};
        \node[draw, circle, fill=gray!50] (C) at (4,0) {C};
        \node[draw, circle, fill=gray!50] (D) at (6,0) {D};
        \node[draw, circle, fill=gray!50] (E) at (8,0) {E};
